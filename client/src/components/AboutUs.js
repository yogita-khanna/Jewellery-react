        ...
        <Droppable droppableId="about-section">
          {(provided) => (
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/jewellery-images/about.avif)`,
                height:"auto"
              }}
            >
              <div className="max-w-4xl mx-auto px-4 py-8 text-green-800 md:px-6 lg:px-8 xl:px-16 xl:py-12 overflow-y-auto">
                <h1 className="text-4xl font-bold mb-4">About Us... (BR SONS JEWELLERS)</h1>
                <div className="flex flex-col w-full">
                  ...
                  <Link to='/aboutus'><button className='mt-3 text-white bg-green-800 px-4 py-2 rounded-lg'>Read More</button></Link>
