...
const Card = ({ content }) => {
  return (
    <motion.div
      className="bg-white bg-opacity-70 text-black hover:text-yellow-600 font-semibold rounded-lg shadow-lg p-6 m-4 transition-transform duration-300 transform hover:scale-105"
        ...
        <Droppable droppableId="about-section">
          {(provided) => (
            <div
              ...
              style={{
                backgroundImage: `url(https://lumengold.com.sg/cdn/shop/articles/9ef5f3a4-012a-4019-845e-39da0407b540.jpg?v=1687147058)`,
                minHeight: '100vh',
              }}
            >
              <div className="backdrop-filter flex flex-col items-center py-16 px-4">
                <h1 className="text-4xl font-extrabold mb-8 text-center text-white">OUR HISTORY</h1>
